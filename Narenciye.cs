...
namespace ndpProje
{
    abstract class Narenciye : IMeyve               //IMeyve arayüzden miras alarak Narenciye abstract sınıfı oluşturdum
    {
        private double mass;                       // random olara meyvenin ağırılığnı verir
